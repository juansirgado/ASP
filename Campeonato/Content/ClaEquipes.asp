...
<head>
   <title>Classifica&ccedil;&atilde;o de equipes</title>
   <link rel="stylesheet" href="../Style/Aplicacao.css" type="text/css">
   <script language="JavaScript" src="../Script/ClaEquipes.js"></script>
   <script language="JavaScript" src="../Script/Button.js"></script>
</head>

<body>
<form method="post" name="frmClaEquipes" action="ClaEquipes.asp">
<center>
<br>
<h1>Classifica&ccedil;&atilde;o de equipes</h1>
...
'===============================================================================
            Response.Write("<table cellpadding=""5"" cellspacing=""5"" class=""table"">" & _
                           "<tr><td>Classifica&ccedil;&atilde;o</td><td>Equipe</td><td>Bandeira</td><td>Escudo</td><td>Vit&oacute;rias</td>" & _
            ...
            While Not equRs.EOF
               ...
               Response.Write("<tr><td align=""center"">" & strClas                          & "</td>" & _
                                  ...
                                  "<td align=""center""><img src=""../Image/Equipe/" & Trim(equRs("equ_cd_equipe")) & ".gif"" " & _
                                  "width=""64px"" height=""48px"" border=""1px""></td>"      & _
                                  "<td align=""center""><img src=""../Image/Equipe/" & Trim(equRs("equ_cd_equipe")) & "b.gif"" " & _
                                  "width=""32px"" height=""48px"" border=""1px""></td>"      & _
...
<input type="button" class="button" name="Listar" value="Listar"
       onClick="JavaScript:equListar(frmClaEquipes);"
...
<input type="button" class="button" name="Limpar" value="Limpar"
       onClick="JavaScript:equLimpar(frmClaEquipes);"
       onMouseOut="javascript:styleButton(this,0);"
       onMouseOver="javascript:styleButton(this,1);"></td><td>
